...
int _main (int argc, char *argv[])
{
    ...
    size_t  icache_ways     	= 1;			//completed// instruction cache number of ways
    size_t  icache_sets     	= 64;			//COMPLETED// instruction cache number of sets
    size_t  icache_words    	= 4;			//COMPLETED// instruction cache number of words per line
    size_t  dcache_ways     	= 1;			//COMPLETED// data cache number of ways
    size_t  dcache_sets     	= 64;			//COMPLETED// data cache number of sets
    size_t  dcache_words    	= 4;			//COMPLETED// data cache number of words per line
