...
#define SEG_RESET_SIZE  0x00001000				//0x00001000
...
int _main (int argc, char *argv[])
{
    ...
    size_t  icache_ways     	= 4;			//completed// instruction cache number of ways
    size_t  icache_sets     	= 256;			//COMPLETED// instruction cache number of sets
    size_t  icache_words    	= 16;			//COMPLETED// instruction cache number of words per line
    size_t  dcache_ways     	= 4;			//COMPLETED// data cache number of ways
    size_t  dcache_sets     	= 256;			//COMPLETED// data cache number of sets
    size_t  dcache_words    	= 16;			//COMPLETED// data cache number of words per line
    size_t  wbuf_depth      	= 8;			//COMPLETED;	// write buffer depth
    ...
    soclib::common::Loader	loader(sys_path, app_path);		//COMPLETED_____________
