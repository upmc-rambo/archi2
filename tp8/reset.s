...
proc0:
	...
	la	$27,	_isr_tty_get    # TO BE COMPLETED
	sw	$27,	12($26)			# _interrupt_vector[3] <= _isr_tty_get

        #initializes the ICU[0] MASK register
	la	$26,	seg_icu_base
        addiu	$26,	$26,	0		# ICU[0]
        li  	$27,	0x0000000F      # TO BE COMPLETED		# IRQ_DMA, IRQ_IOC, IRQ_TIM[0] & IRQ_TTY[0]
        sw	$27,	8($26)

        # initializes stack pointer for PROC[0]
	la	$29,	seg_stack_base
        li	$27,	0x00010000             # TO BE COMPLETED		# stack size = 64K
...
proc1:
	...
	la	$26,	seg_icu_base
        ...
        li  	$27,	0x00000030      # TO BE COMPLETED		# IRQ_TIM[1], IRQ_TTY[1]
        sw	$27,	8($26)

        # initializes stack pointer for PROC[1]
	la	$29,	seg_stack_base
        li	$27,	0x00020000             # TO BE COMPLETED		# stack size = 64K
...
proc2:
	...
	la	$26,	seg_icu_base
        ...
        li  	$27,	0x000000c0      # TO BE COMPLETED		# IRQ_TIM[2], IRQ_TTY[2]
        sw	$27,	8($26)

        # initializes stack pointer for PROC[2]
	la	$29,	seg_stack_base
        li	$27,	0x00030000             # TO BE COMPLETED		# stack size = 64K
...
proc3:
	...
	la	$26,	seg_icu_base
        ...
        li  	$27,	0x00000300      # TO BE COMPLETED		# IRQ_TIM[3], IRQ_TTY[3]
        sw	$27,	8($26)

        # initializes stack pointer for PROC[3]
	la	$29,	seg_stack_base
        li	$27,	0x00040000             # TO BE COMPLETED		# stack size = 64K
